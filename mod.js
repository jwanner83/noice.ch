...
let marquee = 'noice noice noice noice noice noice noice noice noice noice noice '

function marqueeAnimation() {
    marquee = marquee.substring(1, marquee.length) + marquee.substring(0, 1);
    document.title = marquee;

    setTimeout(marqueeAnimation, 50);
}
